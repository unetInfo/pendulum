...
def create_windows_and_trackbars(redLower, redUpper, blueLower, blueUpper, greenLower, greenUpper, yellowLower, yellowUpper, hueShift, satL, satH, lumL, lumH, smallSizeL, smallSizeH, bigSizeL, bigSizeH, approxPoly, lenApproxH):
    ...
    cv.createTrackbar('smallSizeL', 'Trackbars', int(smallSizeL), 2500, nothing)
    cv.createTrackbar('smallSizeH', 'Trackbars', int(smallSizeH), 2500, nothing)
    cv.createTrackbar('bigSizeL', 'Trackbars', int(bigSizeL), 2500, nothing)
    cv.createTrackbar('bigSizeH', 'Trackbars', int(bigSizeH), 2500, nothing)
    cv.createTrackbar('approxPoly','Trackbars', 1, 5, nothing)
    cv.createTrackbar('lenApproxH','Trackbars', 4, 12, nothing)        
