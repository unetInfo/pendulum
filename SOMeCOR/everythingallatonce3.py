...
import time
from somecor_interface3 import find_cameras, create_windows_and_trackbars, read_local_boundaries, save_local_boundaries
...
def generalObjectfinder(lwr_iro_bnd, upr_iro_bnd, color_name, detections):
    ...
    for cnt in cnts:
        ...
        if area > smallSizeL and area < bigSizeH:
            w = radius
            h = radius
            ind = 0
